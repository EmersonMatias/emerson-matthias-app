...
export default function Header() {
    return (
        <header className="flex justify-center items-center h-20 absolute w-full z-10" >
            ...
            <button onClick={() => sendToWpp("Olá Emerson. Gostaria de tirar uma dúvida!")} className="flex items-center text-lg bg-pink-500 px-10 py-2 rounded-2xl absolute right-10 top-5 hover:bg-pink-700 max-md:hidden">
